...
import Messages from "./chat.message.view.js";
...
const Chat = props => {
    ...
    const handleMessageSubmit = text => {
        ...
        axios
            .post("https://activityfinder1.herokuapp.com/chatbot", data, {
                headers: headers
            })
            .then(response => {
                const responseData = {
                    text: response.data["message"] !== "" ? response.data["message"] : "Sorry, I can't get it. Can you please repeat once?",
                    isBot: true
                };
